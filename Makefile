CXX=c++
CXX_FLAGS=-O3 -march=native -std=c++11 -DNDEBUG

all: build/std_unordered_map build/google_sparse_hash_map build/google_dense_hash_map build/google_dense_hash_map_mlf_0_9 
